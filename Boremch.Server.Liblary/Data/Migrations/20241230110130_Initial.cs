        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employes_Branches_BranchId",
                        column: x => x.BranchId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Employes_GeneralDepartments_GeneralDepartmentId",
                        column: x => x.GeneralDepartmentId,
                        principalTable: "GeneralDepartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Employes_Towns_TownId",
                        column: x => x.TownId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employes_GeneralDepartmentId",
                table: "Employes",
                column: "GeneralDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Employes_TownId",
                table: "Employes",
                column: "TownId");
        }
